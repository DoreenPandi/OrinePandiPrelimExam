...
;(async () => {
  ...
  try {
    ...
    const order1 = ['20/04/2021', 'Delivering', 3, 8];
    ...
    const line1 = [poid1.rows[0].po_id, 5];
    ...
    const order2 = ['20/04/2021', 'Delivering', 3, 9];
    ...
    const line2 = [poid2.rows[0].po_id, 6];
    ...
    const order3 = ['20/04/2021', 'Delivering', 3, 10];
    ...
    const line3 = [poid3.rows[0].po_id, 7];
